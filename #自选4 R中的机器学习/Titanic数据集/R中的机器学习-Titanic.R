...
#
#=======================================================================================
#机器学习的几种模型：随机森林、xgboost、神经网络模型、逻辑回归  - 10-fold cross validation
...
train <- read.csv("/Users/wujiawen/Desktop/2018 Autumn/统计软件应用/#自选4 机器学习/train.csv", stringsAsFactors = FALSE)
View(train)
...
# Replace missing embarked values with mode - the most - S(644)
...
# decision trees -> prefer fewer more powerful features
...
# Now, impute! 有几种方法：median，K nearest neighbors and bad decision trees
...
# same across splits.
set.seed(54321)
indexes <- createDataPartition(train$Survived, # reateDataPartition allow you to create stratified random samples 
                               times = 1,
                               p = 0.7,
...
#
cl <- makeCluster(10, type = "SOCK") # 不要开这么多，会挂掉
